...
const file_user_proto_rawDesc = "" +
	...
	"\x11encryptedPassword\x18\x02 \x01(\tR\x11encryptedPassword\"\a\n" +
	"\x05Empty\")\n" +
	...
	"\bbirthday\x18\x04 \x01(\x04R\bbirthday\"O\n" +
	"\x10UserListResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x05R\x05total\x12%\n" +
	"\x04data\x18\x02 \x03(\v2\x11.UserInfoResponseR\x04data\"\xba\x01\n" +
	...
	"\x04role\x18\a \x01(\x05R\x04role2\xa5\x02\n" +
	"\x04User\x12+\n" +
	...
	"\n" +
	"UpdateUser\x12\x0f.UpdateUserInfo\x1a\x06.Empty\x123\n" +
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 11: User.UpdateUser:output_type -> Empty
